...
public class VentanaProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnModificarProducto.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
    ...
    public void agregarListenersBtns(ActionListener aL){
        ...
        btnModificarProducto.addActionListener(aL);
    ...
    public String getProductoSeleccionado(){
        ...
        if(fila == -1){
            ...
            return (String) tablaProductos.getValueAt(fila, 0);
        }
    }
